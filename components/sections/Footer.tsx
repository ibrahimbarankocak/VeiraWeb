...
const colTitle = "mb-3 font-display text-lg font-bold uppercase tracking-wide text-white";
const colLink = "block py-0.5 hover:text-white";
    ...
    <footer className="overflow-hidden border-t border-white/10 px-5 pt-14 md:px-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-12 text-center lg:flex-row lg:items-start lg:justify-between lg:text-left">
        ...
        <div className="grid w-full max-w-md grid-cols-2 justify-items-center gap-8 lg:w-auto lg:max-w-none lg:justify-items-start lg:gap-24">
          <nav className="text-sm text-white/60" aria-label="Product">
          ...
          <nav className="text-sm text-white/60" aria-label="Account">
